...
static void SubstrateHookFunctionX86_64(SubstrateProcessRef process, void *symbol, void *replace, void **result) {
    if (MSDebug)
...
_extern void MSHookX86_64(void *symbol, void *replace, void **result) {
#if defined(__x86_64__)
     SubstrateHookFunctionX86_64(NULL, symbol, replace, result);
#endif
}

_extern void MSHookThumb(void *symbol, void *replace, void **result) {
#if defined(__i386__) || defined(__arm__)
     SubstrateHookFunctionThumb(NULL, symbol, replace, result);
#endif
}
